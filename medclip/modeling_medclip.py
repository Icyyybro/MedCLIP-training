...
class MedCLIPModel(nn.Module):
    def __init__(self,
        ...
        self.text_model = MedCLIPTextModel(bert_type=text_checkpoint if text_checkpoint else constants.BERT_TYPE, proj_bias=False)
    ...
    def from_pretrained(self, input_dir=None):
        ...
        if isinstance(self.vision_model, MedCLIPVisionModel):
            ...
            if input_dir is None:
                input_dir = '/root/autodl-tmp/model/medclip/pretrained/medclip-resnet'
        elif isinstance(self.vision_model, MedCLIPVisionModelViT):
            # ViT
            pretrained_url = constants.PRETRAINED_URL_MEDCLIP_VIT
            if input_dir is None:
                input_dir = '/root/autodl-tmp/model/medclip/pretrained/medclip-vit'
        else:
